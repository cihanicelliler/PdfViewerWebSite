...
$query = "INSERT INTO pdfs (Name,Surname,Student_No,Lesson_Name,Summary,Keywords,Date,Title,Supervisor,Jury_Member,Jury_Member2,Email) 
 VALUES('$name','$surname','$studentNo','$lessonName','$summary','$keywords','$date','$title','$supervisor','$juryMember','$juryMember2','$email')";
